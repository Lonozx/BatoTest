...
function fast_vid_scripts() {
  ...
  */
  ...
  wp_enqueue_style('maincss', get_template_directory_uri() . '/css/main.css', array(), _S_VERSION);
  wp_enqueue_style('form', get_template_directory_uri() . '/css/form.css', array(), _S_VERSION);
  wp_enqueue_style('sections', get_template_directory_uri() . '/css/sections.css', array(), _S_VERSION);
  ...
  */
  ...
  // wp_register_script('jquery', get_template_directory_uri() . '/js/jquery-3.7.1.min.js', array(), _S_VERSION, true);
  ...
  /* подключение вашего скрипта из папки js. Первый аргумент в функции wp_enqueue_script
   ...
   Остальные аргументы можно не менять. 
  */
  wp_enqueue_script('scripts', get_template_directory_uri() . '/js/script.js', array(), _S_VERSION, true);
}
